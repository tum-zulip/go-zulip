...
// [subscribe]: https://zulip.com/api/subscribe
// [search query]: https://zulip.com/help/search-for-messages
func (s *messagesService) GetMessages(ctx context.Context) GetMessagesRequest {
...
//
// [update personal message flags for narrow]: https://zulip.com/api/update-message-flags-for-narrow
func (s *messagesService) MarkAllAsRead(ctx context.Context) MarkAllAsReadRequest {
...
//
// [update personal message flags for narrow]: https://zulip.com/api/update-message-flags-for-narrow
func (s *messagesService) MarkChannelAsRead(ctx context.Context) MarkChannelAsReadRequest {
...
//
// [update personal message flags for narrow]: https://zulip.com/api/update-message-flags-for-narrow
func (s *messagesService) MarkTopicAsRead(ctx context.Context) MarkTopicAsReadRequest {
...
//
// Render a message to HTML.
func (s *messagesService) RenderMessage(ctx context.Context) RenderMessageRequest {
...
// [channel message]: https://zulip.com/help/introduction-to-topics
// [direct message]: https://zulip.com/help/direct-messages
func (s *messagesService) SendMessage(ctx context.Context) SendMessageRequest {
...
//
// [updating flags on a range of messages within a narrow]: https://zulip.com/api/update-message-flags-for-narrow
func (s *messagesService) UpdateMessageFlags(ctx context.Context) UpdateMessageFlagsRequest {
...
func (s *messagesService) UpdateMessageFlagsExecute(r UpdateMessageFlagsRequest) (*UpdateMessageFlagsResponse, *http.Response, error) {
	...
	apiutils.AddParam(form, "flag", r.flag)
	req, err := apiutils.PrepareRequest(r.ctx, s.client, endpoint, method, headers, query, form, nil)
	if err != nil {
		return nil, nil, err
	}
