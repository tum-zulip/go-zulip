...
type UserSettings struct {
	...
	// Whether the user has chosen to send [typing notifications](https://zulip.com/help/typing-notifications) when composing direct messages. The client should send typing notifications for direct messages if and only if this setting is enabled.  **Changes**: New in Zulip 5.0 (feature level 105).
	SendPrivateTypingNotifications bool `json:"send_private_typing_notifications,omitempty"`
	// Whether the user has chosen to send [typing notifications](https://zulip.com/help/typing-notifications) when composing channel messages. The client should send typing notifications for channel messages if and only if this setting is enabled.  **Changes**: New in Zulip 5.0 (feature level 105).
