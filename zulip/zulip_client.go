...
func NewZulipClient(zuliprc *ZulipRC, options ...Option) (*Client, error) {
	if zuliprc == nil {
...
func (c *Client) callAPI(ctx context.Context, request *http.Request) (*http.Response, error) {
	if ctx == nil {
...
func (c *Client) GetZulipRC() *ZulipRC {
	return c.cfg
}
