...
type RealmPermissions struct {
	...
	// Whether this organization's [message edit policy] allows editing the content of messages.  See [`PATCH /messages/{message_id}`](https://zulip.com/api/update-message) for details and history of how message editing permissions work.
