...
func NewEventQueue(client RealTimeEventsAPI, handler EventQueueErrorHandler) *eventQueue {
	return &eventQueue{
		client:       client,
		lastEventId:  atomic.Int64{},
...
func (q *eventQueue) processEvents(ctx context.Context, resp *GetEventsResponse, events chan<- Event) bool {
