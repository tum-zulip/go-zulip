...
**Role** | Pointer to **int32** | [Organization-level role](zulip.com/api/roles-and-permissions of the user. Possible values are:  - 100 &#x3D; Organization owner - 200 &#x3D; Organization administrator - 300 &#x3D; Organization moderator - 400 &#x3D; Member - 600 &#x3D; Guest  **Changes**: New in Zulip 4.0 (feature level 59).  | [optional] 
