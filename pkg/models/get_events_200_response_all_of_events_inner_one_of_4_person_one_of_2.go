...
func NewGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2() *GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2 {
	this := GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2{}
	return &this
}
...
func (o GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2) ToMap() (map[string]interface{}, error) {
...
type NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2 struct {
	value *GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2
	isSet bool
}

func (v NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2) Get() *GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2 {
	return v.value
}

func (v *NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2) Set(val *GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2(val *GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2) *NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2 {
	return &NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2{value: val, isSet: true}
}

func (v NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
