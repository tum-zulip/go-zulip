...
// checks if the RealmBotUpdateEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RealmBotUpdateEvent{}
...
// NewSubscriptionRemoveEvent0 instantiates a new RealmBotUpdateEvent object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSubscriptionRemoveEvent0() *RealmBotUpdateEvent {
	this := RealmBotUpdateEvent{}
	return &this
}

// NewSubscriptionRemoveEvent0WithDefaults instantiates a new RealmBotUpdateEvent object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSubscriptionRemoveEvent0WithDefaults() *RealmBotUpdateEvent {
	this := RealmBotUpdateEvent{}
	return &this
}
...
func (o RealmBotUpdateEvent) MarshalJSON() ([]byte, error) {
...
func (o RealmBotUpdateEvent) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionRemoveEvent0 struct {
	value *RealmBotUpdateEvent
	isSet bool
}

func (v NullableSubscriptionRemoveEvent0) Get() *RealmBotUpdateEvent {
	return v.value
}

func (v *NullableSubscriptionRemoveEvent0) Set(val *RealmBotUpdateEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionRemoveEvent0) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionRemoveEvent0) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionRemoveEvent0(val *RealmBotUpdateEvent) *NullableSubscriptionRemoveEvent0 {
	return &NullableSubscriptionRemoveEvent0{value: val, isSet: true}
}

func (v NullableSubscriptionRemoveEvent0) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionRemoveEvent0) UnmarshalJSON(src []byte) error {
	v.isSet = true
