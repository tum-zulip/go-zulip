...
func NewGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5() *GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5 {
	this := GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5{}
	return &this
}
...
func (o GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5) ToMap() (map[string]interface{}, error) {
...
type NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5 struct {
	value *GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5
	isSet bool
}

func (v NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5) Get() *GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5 {
	return v.value
}

func (v *NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5) Set(val *GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5) {
	v.value = val
	v.isSet = true
}

func (v NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5) IsSet() bool {
	return v.isSet
}

func (v *NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5(val *GetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5) *NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5 {
	return &NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5{value: val, isSet: true}
}

func (v NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetEvents200ResponseAllOfEventsInnerOneOf4PersonOneOf5) UnmarshalJSON(src []byte) error {
	v.isSet = true
