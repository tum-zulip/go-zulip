...
func (o *MessagesEvent) GetLastEditTimestamp() Timestamp {
...
// and a boolean to check if the value has been set.
func (o *MessagesEvent) GetLastEditTimestampOk() (*Timestamp, bool) {
	if o == nil || IsNil(o.LastEditTimestamp) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *MessagesEvent) GetLastMovedTimestampOk() (*Timestamp, bool) {
	if o == nil || IsNil(o.LastMovedTimestamp) {
		return nil, false
	}
...
func (o *MessagesEvent) SetLastMovedTimestamp(v Timestamp) {
...
func (o *MessagesEvent) GetTimestamp() Timestamp {
...
// and a boolean to check if the value has been set.
func (o *MessagesEvent) GetTimestampOk() (*Timestamp, bool) {
	if o == nil || IsNil(o.Timestamp) {
		return nil, false
	}
...
func (o *MessagesEvent) SetTimestamp(v Timestamp) {
	o.Timestamp = &v
}
