...
// checks if the UserUpdateEventActivation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserUpdateEventActivation{}
...
func (o UserUpdateEventActivation) MarshalJSON() ([]byte, error) {
...
func (o UserUpdateEventActivation) ToMap() (map[string]interface{}, error) {
...
type NullableUserUpdateEventActivation struct {
	value *UserUpdateEventActivation
	isSet bool
}

func (v NullableUserUpdateEventActivation) Get() *UserUpdateEventActivation {
	return v.value
}

func (v *NullableUserUpdateEventActivation) Set(val *UserUpdateEventActivation) {
	v.value = val
	v.isSet = true
}

func (v NullableUserUpdateEventActivation) IsSet() bool {
	return v.isSet
}

func (v *NullableUserUpdateEventActivation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserUpdateEventActivation(val *UserUpdateEventActivation) *NullableUserUpdateEventActivation {
	return &NullableUserUpdateEventActivation{value: val, isSet: true}
}

func (v NullableUserUpdateEventActivation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserUpdateEventActivation) UnmarshalJSON(src []byte) error {
	v.isSet = true
