...
// checks if the GetLinkifiers200ResponseAllOfLinkifiersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLinkifiers200ResponseAllOfLinkifiersInner{}
...
func NewGetLinkifiers200ResponseAllOfLinkifiersInner() *GetLinkifiers200ResponseAllOfLinkifiersInner {
	this := GetLinkifiers200ResponseAllOfLinkifiersInner{}
	return &this
}
...
func (o GetLinkifiers200ResponseAllOfLinkifiersInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetLinkifiers200ResponseAllOfLinkifiersInner struct {
	value *GetLinkifiers200ResponseAllOfLinkifiersInner
	isSet bool
}

func (v NullableGetLinkifiers200ResponseAllOfLinkifiersInner) Get() *GetLinkifiers200ResponseAllOfLinkifiersInner {
	return v.value
}

func (v *NullableGetLinkifiers200ResponseAllOfLinkifiersInner) Set(val *GetLinkifiers200ResponseAllOfLinkifiersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLinkifiers200ResponseAllOfLinkifiersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLinkifiers200ResponseAllOfLinkifiersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLinkifiers200ResponseAllOfLinkifiersInner(val *GetLinkifiers200ResponseAllOfLinkifiersInner) *NullableGetLinkifiers200ResponseAllOfLinkifiersInner {
	return &NullableGetLinkifiers200ResponseAllOfLinkifiersInner{value: val, isSet: true}
}

func (v NullableGetLinkifiers200ResponseAllOfLinkifiersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLinkifiers200ResponseAllOfLinkifiersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
