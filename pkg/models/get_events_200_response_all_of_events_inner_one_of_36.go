...
type _GetEvents200ResponseAllOfEventsInnerOneOf36 GetEvents200ResponseAllOfEventsInnerOneOf36

// NewGetEvents200ResponseAllOfEventsInnerOneOf36 instantiates a new GetEvents200ResponseAllOfEventsInnerOneOf36 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetEvents200ResponseAllOfEventsInnerOneOf36(id int32, type_ string, userId NullableInt32, renderingOnly bool, messageId int32, messageIds []int32, flags []string, editTimestamp int32) *GetEvents200ResponseAllOfEventsInnerOneOf36 {
	this := GetEvents200ResponseAllOfEventsInnerOneOf36{}
	this.Id = id
	this.Type = type_
	this.UserId = userId
...
// NewGetEvents200ResponseAllOfEventsInnerOneOf36WithDefaults instantiates a new GetEvents200ResponseAllOfEventsInnerOneOf36 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetEvents200ResponseAllOfEventsInnerOneOf36WithDefaults() *GetEvents200ResponseAllOfEventsInnerOneOf36 {
	this := GetEvents200ResponseAllOfEventsInnerOneOf36{}
	return &this
}

// GetId returns the Id field value
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetId() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetId(v int32) {
	o.Id = v
}

// GetType returns the Type field value
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetType(v string) {
	o.Type = v
}

// GetUserId returns the UserId field value
// If the value is explicit nil, the zero value for int32 will be returned
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetUserId() int32 {
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetUserIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetUserId(v int32) {
	o.UserId.Set(&v)
}

// GetRenderingOnly returns the RenderingOnly field value
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetRenderingOnly() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetRenderingOnlyOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetRenderingOnly(v bool) {
	o.RenderingOnly = v
}

// GetMessageId returns the MessageId field value
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetMessageId() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetMessageIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetMessageId(v int32) {
	o.MessageId = v
}

// GetMessageIds returns the MessageIds field value
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetMessageIds() []int32 {
	if o == nil {
		var ret []int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetMessageIdsOk() ([]int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetMessageIds(v []int32) {
	o.MessageIds = v
}

// GetFlags returns the Flags field value
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetFlags() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetFlagsOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.Flags, true
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetFlags(v []string) {
	o.Flags = v
}

// GetEditTimestamp returns the EditTimestamp field value
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetEditTimestamp() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetEditTimestampOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetEditTimestamp(v int32) {
	o.EditTimestamp = v
}

// GetStreamName returns the StreamName field value if set, zero value otherwise.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetStreamName() string {
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetStreamNameOk() (*string, bool) {
	if o == nil || IsNil(o.StreamName) {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) HasStreamName() bool {
	if o != nil && !IsNil(o.StreamName) {
		return true
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetStreamName(v string) {
	o.StreamName = &v
}

// GetStreamId returns the StreamId field value if set, zero value otherwise.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetStreamId() int32 {
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetStreamIdOk() (*int32, bool) {
	if o == nil || IsNil(o.StreamId) {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) HasStreamId() bool {
	if o != nil && !IsNil(o.StreamId) {
		return true
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetStreamId(v int32) {
	o.StreamId = &v
}

// GetNewStreamId returns the NewStreamId field value if set, zero value otherwise.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetNewStreamId() int32 {
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetNewStreamIdOk() (*int32, bool) {
	if o == nil || IsNil(o.NewStreamId) {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) HasNewStreamId() bool {
	if o != nil && !IsNil(o.NewStreamId) {
		return true
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetNewStreamId(v int32) {
	o.NewStreamId = &v
}

// GetPropagateMode returns the PropagateMode field value if set, zero value otherwise.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetPropagateMode() string {
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetPropagateModeOk() (*string, bool) {
	if o == nil || IsNil(o.PropagateMode) {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) HasPropagateMode() bool {
	if o != nil && !IsNil(o.PropagateMode) {
		return true
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetPropagateMode(v string) {
	o.PropagateMode = &v
}

// GetOrigSubject returns the OrigSubject field value if set, zero value otherwise.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetOrigSubject() string {
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetOrigSubjectOk() (*string, bool) {
	if o == nil || IsNil(o.OrigSubject) {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) HasOrigSubject() bool {
	if o != nil && !IsNil(o.OrigSubject) {
		return true
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetOrigSubject(v string) {
	o.OrigSubject = &v
}

// GetSubject returns the Subject field value if set, zero value otherwise.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetSubject() string {
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetSubjectOk() (*string, bool) {
	if o == nil || IsNil(o.Subject) {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) HasSubject() bool {
	if o != nil && !IsNil(o.Subject) {
		return true
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetSubject(v string) {
	o.Subject = &v
}

// GetTopicLinks returns the TopicLinks field value if set, zero value otherwise.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetTopicLinks() []GetEvents200ResponseAllOfEventsInnerOneOf36TopicLinksInner {
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetTopicLinksOk() ([]GetEvents200ResponseAllOfEventsInnerOneOf36TopicLinksInner, bool) {
	if o == nil || IsNil(o.TopicLinks) {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) HasTopicLinks() bool {
	if o != nil && !IsNil(o.TopicLinks) {
		return true
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetTopicLinks(v []GetEvents200ResponseAllOfEventsInnerOneOf36TopicLinksInner) {
	o.TopicLinks = v
}

// GetOrigContent returns the OrigContent field value if set, zero value otherwise.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetOrigContent() string {
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetOrigContentOk() (*string, bool) {
	if o == nil || IsNil(o.OrigContent) {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) HasOrigContent() bool {
	if o != nil && !IsNil(o.OrigContent) {
		return true
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetOrigContent(v string) {
	o.OrigContent = &v
}

// GetOrigRenderedContent returns the OrigRenderedContent field value if set, zero value otherwise.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetOrigRenderedContent() string {
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetOrigRenderedContentOk() (*string, bool) {
	if o == nil || IsNil(o.OrigRenderedContent) {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) HasOrigRenderedContent() bool {
	if o != nil && !IsNil(o.OrigRenderedContent) {
		return true
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetOrigRenderedContent(v string) {
	o.OrigRenderedContent = &v
}

// GetContent returns the Content field value if set, zero value otherwise.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetContent() string {
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetContentOk() (*string, bool) {
	if o == nil || IsNil(o.Content) {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) HasContent() bool {
	if o != nil && !IsNil(o.Content) {
		return true
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetContent(v string) {
	o.Content = &v
}

// GetRenderedContent returns the RenderedContent field value if set, zero value otherwise.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetRenderedContent() string {
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetRenderedContentOk() (*string, bool) {
	if o == nil || IsNil(o.RenderedContent) {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) HasRenderedContent() bool {
	if o != nil && !IsNil(o.RenderedContent) {
		return true
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetRenderedContent(v string) {
	o.RenderedContent = &v
}

// GetIsMeMessage returns the IsMeMessage field value if set, zero value otherwise.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetIsMeMessage() bool {
...
// and a boolean to check if the value has been set.
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) GetIsMeMessageOk() (*bool, bool) {
	if o == nil || IsNil(o.IsMeMessage) {
		return nil, false
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) HasIsMeMessage() bool {
	if o != nil && !IsNil(o.IsMeMessage) {
		return true
	}
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) SetIsMeMessage(v bool) {
	o.IsMeMessage = &v
}
...
func (o GetEvents200ResponseAllOfEventsInnerOneOf36) ToMap() (map[string]interface{}, error) {
...
func (o *GetEvents200ResponseAllOfEventsInnerOneOf36) UnmarshalJSON(data []byte) (err error) {
	...
	varGetEvents200ResponseAllOfEventsInnerOneOf36 := _GetEvents200ResponseAllOfEventsInnerOneOf36{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetEvents200ResponseAllOfEventsInnerOneOf36)

	if err != nil {
		return err
	}

	*o = GetEvents200ResponseAllOfEventsInnerOneOf36(varGetEvents200ResponseAllOfEventsInnerOneOf36)

	return err
}

type NullableGetEvents200ResponseAllOfEventsInnerOneOf36 struct {
	value *GetEvents200ResponseAllOfEventsInnerOneOf36
	isSet bool
}

func (v NullableGetEvents200ResponseAllOfEventsInnerOneOf36) Get() *GetEvents200ResponseAllOfEventsInnerOneOf36 {
	return v.value
}

func (v *NullableGetEvents200ResponseAllOfEventsInnerOneOf36) Set(val *GetEvents200ResponseAllOfEventsInnerOneOf36) {
	v.value = val
	v.isSet = true
}

func (v NullableGetEvents200ResponseAllOfEventsInnerOneOf36) IsSet() bool {
	return v.isSet
}

func (v *NullableGetEvents200ResponseAllOfEventsInnerOneOf36) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetEvents200ResponseAllOfEventsInnerOneOf36(val *GetEvents200ResponseAllOfEventsInnerOneOf36) *NullableGetEvents200ResponseAllOfEventsInnerOneOf36 {
	return &NullableGetEvents200ResponseAllOfEventsInnerOneOf36{value: val, isSet: true}
}

func (v NullableGetEvents200ResponseAllOfEventsInnerOneOf36) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetEvents200ResponseAllOfEventsInnerOneOf36) UnmarshalJSON(src []byte) error {
	v.isSet = true
