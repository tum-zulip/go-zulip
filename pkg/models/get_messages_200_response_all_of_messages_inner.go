...
func (o *GetMessages200ResponseAllOfMessagesInner) GetLastEditTimestamp() Timestamp {
...
// and a boolean to check if the value has been set.
func (o *GetMessages200ResponseAllOfMessagesInner) GetLastEditTimestampOk() (*Timestamp, bool) {
	if o == nil || IsNil(o.LastEditTimestamp) {
		return nil, false
	}
...
func (o *GetMessages200ResponseAllOfMessagesInner) SetLastEditTimestamp(v Timestamp) {
	o.LastEditTimestamp = &v
}

// GetLastMovedTimestamp returns the LastMovedTimestamp field value if set, zero value otherwise.
func (o *GetMessages200ResponseAllOfMessagesInner) GetLastMovedTimestamp() Timestamp {
...
// and a boolean to check if the value has been set.
func (o *GetMessages200ResponseAllOfMessagesInner) GetLastMovedTimestampOk() (*Timestamp, bool) {
	if o == nil || IsNil(o.LastMovedTimestamp) {
		return nil, false
	}
...
func (o *GetMessages200ResponseAllOfMessagesInner) SetLastMovedTimestamp(v Timestamp) {
...
func (o *GetMessages200ResponseAllOfMessagesInner) GetTimestamp() Timestamp {
...
// and a boolean to check if the value has been set.
func (o *GetMessages200ResponseAllOfMessagesInner) GetTimestampOk() (*Timestamp, bool) {
	if o == nil || IsNil(o.Timestamp) {
		return nil, false
	}
...
func (o *GetMessages200ResponseAllOfMessagesInner) SetTimestamp(v Timestamp) {
	o.Timestamp = &v
}

// GetTopicLinks returns the TopicLinks field value if set, zero value otherwise.
func (o *GetMessages200ResponseAllOfMessagesInner) GetTopicLinks() []UserSettingsUpdateEvent6TopicLinksInner {
...
// and a boolean to check if the value has been set.
func (o *GetMessages200ResponseAllOfMessagesInner) GetTopicLinksOk() ([]UserSettingsUpdateEvent6TopicLinksInner, bool) {
	if o == nil || IsNil(o.TopicLinks) {
		return nil, false
	}
...
func (o *GetMessages200ResponseAllOfMessagesInner) SetTopicLinks(v []UserSettingsUpdateEvent6TopicLinksInner) {
	o.TopicLinks = v
}
