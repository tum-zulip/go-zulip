...
// checks if the RealmUpdateEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RealmUpdateEvent{}
...
type RealmUpdateEvent struct {
	...
	Value    *SubscriptionRemoveEvent3Value `json:"value,omitempty"`
}

// NewSubscriptionRemoveEvent3 instantiates a new RealmUpdateEvent object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSubscriptionRemoveEvent3() *RealmUpdateEvent {
	this := RealmUpdateEvent{}
	return &this
}

// NewSubscriptionRemoveEvent3WithDefaults instantiates a new RealmUpdateEvent object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSubscriptionRemoveEvent3WithDefaults() *RealmUpdateEvent {
	this := RealmUpdateEvent{}
	return &this
}
...
func (o *RealmUpdateEvent) GetValue() SubscriptionRemoveEvent3Value {
	if o == nil || IsNil(o.Value) {
		var ret SubscriptionRemoveEvent3Value
		return ret
	}
	return *o.Value
}
...
// and a boolean to check if the value has been set.
func (o *RealmUpdateEvent) GetValueOk() (*SubscriptionRemoveEvent3Value, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given SubscriptionRemoveEvent3Value and assigns it to the Value field.
func (o *RealmUpdateEvent) SetValue(v SubscriptionRemoveEvent3Value) {
	o.Value = &v
}

func (o RealmUpdateEvent) MarshalJSON() ([]byte, error) {
...
func (o RealmUpdateEvent) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionRemoveEvent3 struct {
	value *RealmUpdateEvent
	isSet bool
}

func (v NullableSubscriptionRemoveEvent3) Get() *RealmUpdateEvent {
	return v.value
}

func (v *NullableSubscriptionRemoveEvent3) Set(val *RealmUpdateEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionRemoveEvent3) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionRemoveEvent3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionRemoveEvent3(val *RealmUpdateEvent) *NullableSubscriptionRemoveEvent3 {
	return &NullableSubscriptionRemoveEvent3{value: val, isSet: true}
}

func (v NullableSubscriptionRemoveEvent3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionRemoveEvent3) UnmarshalJSON(src []byte) error {
	v.isSet = true
