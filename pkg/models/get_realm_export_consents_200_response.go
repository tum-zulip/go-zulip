...
func NewGetRealmExportConsents200Response(result string, msg string) *GetRealmExportConsents200Response {
...
func (o *GetRealmExportConsents200Response) GetResult() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *GetRealmExportConsents200Response) GetResultOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetRealmExportConsents200Response) SetResult(v string) {
	o.Result = v
}

// GetMsg returns the Msg field value
func (o *GetRealmExportConsents200Response) GetMsg() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetRealmExportConsents200Response) GetMsgOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Msg, true
...
func (o *GetRealmExportConsents200Response) SetMsg(v string) {
	o.Msg = v
}

// GetIgnoredParametersUnsupported returns the IgnoredParametersUnsupported field value if set, zero value otherwise.
func (o *GetRealmExportConsents200Response) GetIgnoredParametersUnsupported() []string {
...
// and a boolean to check if the value has been set.
func (o *GetRealmExportConsents200Response) GetIgnoredParametersUnsupportedOk() ([]string, bool) {
	if o == nil || IsNil(o.IgnoredParametersUnsupported) {
		return nil, false
	}
...
func (o *GetRealmExportConsents200Response) SetIgnoredParametersUnsupported(v []string) {
