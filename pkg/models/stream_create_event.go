...
// checks if the StreamCreateEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamCreateEvent{}
...
// NewUpdateDisplaySettingsEvent6 instantiates a new StreamCreateEvent object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUpdateDisplaySettingsEvent6() *StreamCreateEvent {
	this := StreamCreateEvent{}
	return &this
}

// NewUpdateDisplaySettingsEvent6WithDefaults instantiates a new StreamCreateEvent object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUpdateDisplaySettingsEvent6WithDefaults() *StreamCreateEvent {
	this := StreamCreateEvent{}
	return &this
}
...
func (o StreamCreateEvent) MarshalJSON() ([]byte, error) {
...
func (o StreamCreateEvent) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateDisplaySettingsEvent6 struct {
	value *StreamCreateEvent
	isSet bool
}

func (v NullableUpdateDisplaySettingsEvent6) Get() *StreamCreateEvent {
	return v.value
}

func (v *NullableUpdateDisplaySettingsEvent6) Set(val *StreamCreateEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateDisplaySettingsEvent6) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateDisplaySettingsEvent6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateDisplaySettingsEvent6(val *StreamCreateEvent) *NullableUpdateDisplaySettingsEvent6 {
	return &NullableUpdateDisplaySettingsEvent6{value: val, isSet: true}
}

func (v NullableUpdateDisplaySettingsEvent6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateDisplaySettingsEvent6) UnmarshalJSON(src []byte) error {
	v.isSet = true
