...
func NewUpdateMessage200Response(result string, msg string) *UpdateMessage200Response {
...
func (o *UpdateMessage200Response) GetResult() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *UpdateMessage200Response) GetResultOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UpdateMessage200Response) SetResult(v string) {
	o.Result = v
}

// GetMsg returns the Msg field value
func (o *UpdateMessage200Response) GetMsg() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *UpdateMessage200Response) GetMsgOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Msg, true
...
func (o *UpdateMessage200Response) SetMsg(v string) {
	o.Msg = v
}

// GetIgnoredParametersUnsupported returns the IgnoredParametersUnsupported field value if set, zero value otherwise.
func (o *UpdateMessage200Response) GetIgnoredParametersUnsupported() []string {
...
// and a boolean to check if the value has been set.
func (o *UpdateMessage200Response) GetIgnoredParametersUnsupportedOk() ([]string, bool) {
	if o == nil || IsNil(o.IgnoredParametersUnsupported) {
		return nil, false
	}
...
func (o *UpdateMessage200Response) SetIgnoredParametersUnsupported(v []string) {
