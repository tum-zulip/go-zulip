...
type PresenceEvent struct {
	...
	// Not present for clients that support the `simplified_presence_events` [client capability](zulip.com/api/register-queue#parameter-client_capabilities.  The ID of the modified user.
	UserId *int32 `json:"user_id,omitempty"`
	// Not present for clients that support the `simplified_presence_events` [client capability](zulip.com/api/register-queue#parameter-client_capabilities.  The Zulip API email of the user.  **Deprecated**: This field will be removed in a future release as it is redundant with the `user_id`.
	// Deprecated
	Email *string `json:"email,omitempty"`
	// Not present for clients that support the `simplified_presence_events` [client capability](zulip.com/api/register-queue#parameter-client_capabilities.  The timestamp of when the Zulip server received the user's presence as a UNIX timestamp.
	ServerTimestamp *float32 `json:"server_timestamp,omitempty"`
	// Not present for clients that support the `simplified_presence_events` [client capability](zulip.com/api/register-queue#parameter-client_capabilities.  Object containing the presence data (legacy format) of of the modified user.
