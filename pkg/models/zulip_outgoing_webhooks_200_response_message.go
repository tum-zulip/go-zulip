...
func (o *ZulipOutgoingWebhooks200ResponseMessage) GetLastEditTimestamp() int32 {
...
// and a boolean to check if the value has been set.
func (o *ZulipOutgoingWebhooks200ResponseMessage) GetLastEditTimestampOk() (*int32, bool) {
	if o == nil || IsNil(o.LastEditTimestamp) {
		return nil, false
	}
...
func (o *ZulipOutgoingWebhooks200ResponseMessage) SetLastEditTimestamp(v int32) {
	o.LastEditTimestamp = &v
}

// GetLastMovedTimestamp returns the LastMovedTimestamp field value if set, zero value otherwise.
func (o *ZulipOutgoingWebhooks200ResponseMessage) GetLastMovedTimestamp() int32 {
...
// and a boolean to check if the value has been set.
func (o *ZulipOutgoingWebhooks200ResponseMessage) GetLastMovedTimestampOk() (*int32, bool) {
	if o == nil || IsNil(o.LastMovedTimestamp) {
		return nil, false
	}
...
func (o *ZulipOutgoingWebhooks200ResponseMessage) SetLastMovedTimestamp(v int32) {
...
func (o *ZulipOutgoingWebhooks200ResponseMessage) GetTimestamp() int32 {
...
// and a boolean to check if the value has been set.
func (o *ZulipOutgoingWebhooks200ResponseMessage) GetTimestampOk() (*int32, bool) {
	if o == nil || IsNil(o.Timestamp) {
		return nil, false
	}
...
func (o *ZulipOutgoingWebhooks200ResponseMessage) SetTimestamp(v int32) {
	o.Timestamp = &v
}

// GetTopicLinks returns the TopicLinks field value if set, zero value otherwise.
func (o *ZulipOutgoingWebhooks200ResponseMessage) GetTopicLinks() []GetEvents200ResponseAllOfEventsInnerOneOf36TopicLinksInner {
...
// and a boolean to check if the value has been set.
func (o *ZulipOutgoingWebhooks200ResponseMessage) GetTopicLinksOk() ([]GetEvents200ResponseAllOfEventsInnerOneOf36TopicLinksInner, bool) {
	if o == nil || IsNil(o.TopicLinks) {
		return nil, false
	}
...
func (o *ZulipOutgoingWebhooks200ResponseMessage) SetTopicLinks(v []GetEvents200ResponseAllOfEventsInnerOneOf36TopicLinksInner) {
	o.TopicLinks = v
}
