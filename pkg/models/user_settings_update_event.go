...
// checks if the UserSettingsUpdateEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserSettingsUpdateEvent{}
...
type UserSettingsUpdateEvent struct {
	...
	Value    *UpdateDisplaySettingsEventSetting `json:"value,omitempty"`
...
// NewUserSettingsUpdateEvent instantiates a new UserSettingsUpdateEvent object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUserSettingsUpdateEvent() *UserSettingsUpdateEvent {
	this := UserSettingsUpdateEvent{}
	return &this
}

// NewUserSettingsUpdateEventWithDefaults instantiates a new UserSettingsUpdateEvent object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUserSettingsUpdateEventWithDefaults() *UserSettingsUpdateEvent {
	this := UserSettingsUpdateEvent{}
	return &this
}
...
func (o *UserSettingsUpdateEvent) GetValue() UpdateDisplaySettingsEventSetting {
...
// and a boolean to check if the value has been set.
func (o *UserSettingsUpdateEvent) GetValueOk() (*UpdateDisplaySettingsEventSetting, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given UpdateDisplaySettingsEventSetting and assigns it to the Value field.
func (o *UserSettingsUpdateEvent) SetValue(v UpdateDisplaySettingsEventSetting) {
	o.Value = &v
}
...
func (o UserSettingsUpdateEvent) MarshalJSON() ([]byte, error) {
...
func (o UserSettingsUpdateEvent) ToMap() (map[string]interface{}, error) {
...
type NullableUserSettingsUpdateEvent struct {
	value *UserSettingsUpdateEvent
	isSet bool
}

func (v NullableUserSettingsUpdateEvent) Get() *UserSettingsUpdateEvent {
	return v.value
}

func (v *NullableUserSettingsUpdateEvent) Set(val *UserSettingsUpdateEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableUserSettingsUpdateEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableUserSettingsUpdateEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserSettingsUpdateEvent(val *UserSettingsUpdateEvent) *NullableUserSettingsUpdateEvent {
	return &NullableUserSettingsUpdateEvent{value: val, isSet: true}
}

func (v NullableUserSettingsUpdateEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserSettingsUpdateEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
