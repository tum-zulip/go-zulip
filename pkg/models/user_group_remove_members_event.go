...
// NewRealmUserUpdateEvent6 instantiates a new UserGroupRemoveMembersEvent object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRealmUserUpdateEvent6() *UserGroupRemoveMembersEvent {
	this := UserGroupRemoveMembersEvent{}
	return &this
}

// NewRealmUserUpdateEvent6WithDefaults instantiates a new UserGroupRemoveMembersEvent object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRealmUserUpdateEvent6WithDefaults() *UserGroupRemoveMembersEvent {
	this := UserGroupRemoveMembersEvent{}
	return &this
}
...
func (o UserGroupRemoveMembersEvent) MarshalJSON() ([]byte, error) {
...
func (o UserGroupRemoveMembersEvent) ToMap() (map[string]interface{}, error) {
...
type NullableRealmUserUpdateEvent6 struct {
	value *UserGroupRemoveMembersEvent
	isSet bool
}

func (v NullableRealmUserUpdateEvent6) Get() *UserGroupRemoveMembersEvent {
	return v.value
}

func (v *NullableRealmUserUpdateEvent6) Set(val *UserGroupRemoveMembersEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableRealmUserUpdateEvent6) IsSet() bool {
	return v.isSet
}

func (v *NullableRealmUserUpdateEvent6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRealmUserUpdateEvent6(val *UserGroupRemoveMembersEvent) *NullableRealmUserUpdateEvent6 {
	return &NullableRealmUserUpdateEvent6{value: val, isSet: true}
}

func (v NullableRealmUserUpdateEvent6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRealmUserUpdateEvent6) UnmarshalJSON(src []byte) error {
	v.isSet = true
