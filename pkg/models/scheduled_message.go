...
func NewScheduledMessage(scheduledMessageId int32, recipientType RecipientType, to Recipients, content string, renderedContent string, scheduledDeliveryTimestamp Timestamp, failed bool) *ScheduledMessage {
...
func (o *ScheduledMessage) GetType() RecipientType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ScheduledMessage) GetTypeOk() (*RecipientType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *ScheduledMessage) SetType(v RecipientType) {
	o.Type = v
}

// GetTo returns the To field value
func (o *ScheduledMessage) GetTo() Recipients {
	if o == nil {
		var ret Recipients
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScheduledMessage) GetToOk() (*Recipients, bool) {
	if o == nil {
		return nil, false
	}
	return &o.To, true
...
func (o *ScheduledMessage) SetTo(v Recipients) {
	o.To = v
}
...
func (o *ScheduledMessage) GetScheduledDeliveryTimestamp() Timestamp {
	if o == nil {
		var ret Timestamp
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScheduledMessage) GetScheduledDeliveryTimestampOk() (*Timestamp, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScheduledMessage) SetScheduledDeliveryTimestamp(v Timestamp) {
