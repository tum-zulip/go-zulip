...
func NewScheduledMessage(scheduledMessageId int32, type_ string, to Recipients, content string, renderedContent string, scheduledDeliveryTimestamp int32, failed bool) *ScheduledMessage {
