...
func NewGetSubscriptions200Response(result string, msg string, subscriptions []Subscription) *GetSubscriptions200Response {
...
func (o *GetSubscriptions200Response) GetResult() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *GetSubscriptions200Response) GetResultOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetSubscriptions200Response) SetResult(v string) {
	o.Result = v
}

// GetMsg returns the Msg field value
func (o *GetSubscriptions200Response) GetMsg() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetSubscriptions200Response) GetMsgOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Msg, true
...
func (o *GetSubscriptions200Response) SetMsg(v string) {
	o.Msg = v
}

// GetIgnoredParametersUnsupported returns the IgnoredParametersUnsupported field value if set, zero value otherwise.
func (o *GetSubscriptions200Response) GetIgnoredParametersUnsupported() []string {
...
// and a boolean to check if the value has been set.
func (o *GetSubscriptions200Response) GetIgnoredParametersUnsupportedOk() ([]string, bool) {
	if o == nil || IsNil(o.IgnoredParametersUnsupported) {
		return nil, false
	}
...
func (o *GetSubscriptions200Response) SetIgnoredParametersUnsupported(v []string) {
