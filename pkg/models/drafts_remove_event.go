...
// checks if the DraftsRemoveEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DraftsRemoveEvent{}
...
// NewSubscriptionUpdateEvent1 instantiates a new DraftsRemoveEvent object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSubscriptionUpdateEvent1() *DraftsRemoveEvent {
	this := DraftsRemoveEvent{}
	return &this
}

// NewSubscriptionUpdateEvent1WithDefaults instantiates a new DraftsRemoveEvent object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSubscriptionUpdateEvent1WithDefaults() *DraftsRemoveEvent {
	this := DraftsRemoveEvent{}
	return &this
}
...
func (o DraftsRemoveEvent) MarshalJSON() ([]byte, error) {
...
func (o DraftsRemoveEvent) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionUpdateEvent1 struct {
	value *DraftsRemoveEvent
	isSet bool
}

func (v NullableSubscriptionUpdateEvent1) Get() *DraftsRemoveEvent {
	return v.value
}

func (v *NullableSubscriptionUpdateEvent1) Set(val *DraftsRemoveEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionUpdateEvent1) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionUpdateEvent1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionUpdateEvent1(val *DraftsRemoveEvent) *NullableSubscriptionUpdateEvent1 {
	return &NullableSubscriptionUpdateEvent1{value: val, isSet: true}
}

func (v NullableSubscriptionUpdateEvent1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionUpdateEvent1) UnmarshalJSON(src []byte) error {
	v.isSet = true
