...
// checks if the NarrowMatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NarrowMatch{}
...
func (o NarrowMatch) MarshalJSON() ([]byte, error) {
...
func (o NarrowMatch) ToMap() (map[string]interface{}, error) {
...
type NullableNarrowMatch struct {
	value *NarrowMatch
	isSet bool
}

func (v NullableNarrowMatch) Get() *NarrowMatch {
	return v.value
}

func (v *NullableNarrowMatch) Set(val *NarrowMatch) {
	v.value = val
	v.isSet = true
}

func (v NullableNarrowMatch) IsSet() bool {
	return v.isSet
}

func (v *NullableNarrowMatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNarrowMatch(val *NarrowMatch) *NullableNarrowMatch {
	return &NullableNarrowMatch{value: val, isSet: true}
}

func (v NullableNarrowMatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNarrowMatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
