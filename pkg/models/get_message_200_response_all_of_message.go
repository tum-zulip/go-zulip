...
func (o *GetMessage200ResponseAllOfMessage) GetTopicLinks() []GetEvents200ResponseAllOfEventsInnerOneOf36TopicLinksInner {
...
// and a boolean to check if the value has been set.
func (o *GetMessage200ResponseAllOfMessage) GetTopicLinksOk() ([]GetEvents200ResponseAllOfEventsInnerOneOf36TopicLinksInner, bool) {
	if o == nil || IsNil(o.TopicLinks) {
		return nil, false
	}
...
func (o *GetMessage200ResponseAllOfMessage) SetTopicLinks(v []GetEvents200ResponseAllOfEventsInnerOneOf36TopicLinksInner) {
	o.TopicLinks = v
}
