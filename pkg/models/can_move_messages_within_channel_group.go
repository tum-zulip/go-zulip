...
func NewCanMoveMessagesWithinChannelGroup() *CanMoveMessagesWithinChannelGroup {
	this := CanMoveMessagesWithinChannelGroup{}
	return &this
}
...
func (o CanMoveMessagesWithinChannelGroup) ToMap() (map[string]interface{}, error) {
...
type NullableCanMoveMessagesWithinChannelGroup struct {
	value *CanMoveMessagesWithinChannelGroup
	isSet bool
}

func (v NullableCanMoveMessagesWithinChannelGroup) Get() *CanMoveMessagesWithinChannelGroup {
	return v.value
}

func (v *NullableCanMoveMessagesWithinChannelGroup) Set(val *CanMoveMessagesWithinChannelGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableCanMoveMessagesWithinChannelGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableCanMoveMessagesWithinChannelGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCanMoveMessagesWithinChannelGroup(val *CanMoveMessagesWithinChannelGroup) *NullableCanMoveMessagesWithinChannelGroup {
	return &NullableCanMoveMessagesWithinChannelGroup{value: val, isSet: true}
}

func (v NullableCanMoveMessagesWithinChannelGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCanMoveMessagesWithinChannelGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
