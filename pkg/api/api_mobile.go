...
**Changes**: New in Zulip 11.0 (feature level 420).
	...
	@return E2eeTestNotifyRequest
*/
func (c *ZulipClient) E2eeTestNotify(ctx context.Context) E2eeTestNotifyRequest {
	return E2eeTestNotifyRequest{
		ApiService: c,
		ctx:        ctx,
	}
...
//
//	@return Response
func (c *ZulipClient) E2eeTestNotifyExecute(r E2eeTestNotifyRequest) (*Response, *http.Response, error) {
	var (
...
**Changes**: New in Zulip 11.0 (feature level 406).
	...
	@return RegisterPushDeviceRequest
*/
func (c *ZulipClient) RegisterPushDevice(ctx context.Context) RegisterPushDeviceRequest {
	return RegisterPushDeviceRequest{
		ApiService: c,
		ctx:        ctx,
	}
...
//
//	@return Response
func (c *ZulipClient) RegisterPushDeviceExecute(r RegisterPushDeviceRequest) (*Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
New in Zulip 8.0 (feature level 217).
	...
	@return TestNotifyRequest
*/
func (c *ZulipClient) TestNotify(ctx context.Context) TestNotifyRequest {
	return TestNotifyRequest{
		ApiService: c,
		ctx:        ctx,
	}
...
//
//	@return Response
func (c *ZulipClient) TestNotifyExecute(r TestNotifyRequest) (*Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
