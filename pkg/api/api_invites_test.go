...
func Test_InvitesAPIService(t *testing.T) {
	...
	t.Run("InviteLinkLifecycle", runForAdminAndOwnerClients(t, func(t *testing.T, apiClient *api.ZulipClient) {
	...
	t.Run("EmailInviteLifecycle", runForAllClients(t, func(t *testing.T, apiClient *api.ZulipClient) {
		ctx := context.Background()
