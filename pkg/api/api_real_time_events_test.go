...
func Test_RealTimeEventsAPIService(t *testing.T) {
	...
	t.Run("DeleteQueue", runForAllClients(t, func(t *testing.T, apiClient *api.ZulipClient) {
	...
	t.Run("GetEvents", runForAllClients(t, func(t *testing.T, apiClient *api.ZulipClient) {
		ctx := context.Background()
	...
	t.Run("RealTimePost", runForAllClients(t, func(t *testing.T, apiClient *api.ZulipClient) {
		ctx := context.Background()
	...
	t.Run("RegisterQueue", runForAllClients(t, func(t *testing.T, apiClient *api.ZulipClient) {
		ctx := context.Background()
	...
	t.Run("QueueReceivesMessageEvent", runForAllClients(t, func(t *testing.T, apiClient *api.ZulipClient) {
	...
	t.Run("RestErrorHandling", runForAllClients(t, func(t *testing.T, apiClient *api.ZulipClient) {
		ctx := context.Background()
...
func registerMessageEventQueue(t *testing.T, apiClient *api.ZulipClient) eventQueueState {
	t.Helper()
...
func fetchQueueEvents(t *testing.T, ctx context.Context, apiClient *api.ZulipClient, queueID string, lastEventID int64, dontBlock bool) ([]json.RawMessage, int64) {
	t.Helper()
